...
'Требования к css +4\n' +
'\n' +
'при уменьшении масштаба страницы браузера или увеличении ширины страницы вёрстка размещается по центру, а не сдвигается в сторону и не растягивается по всей ширине +2\n' +
'фоновый цвет тянется на всю ширину страницы +2\n' +
